...
public class FtpPathResolver {
     ...
     * 笔记文件的相对路径。
     */
    public static final String[] RELATIVE_PATH_NOTE_FILE = new String[]{"note-file"};

    /**
     * 附件文件的相对路径。
     */
    public static final String[] RELATIVE_PATH_ATTACHMENT_FILE = new String[]{"attachment-file"};
     ...
     * <ul>
     *     <li>{@link #RELATIVE_PATH_NOTE_FILE}</li>
     *     <li>{@link #RELATIVE_PATH_ATTACHMENT_FILE}</li>
     * </ul>
     *
